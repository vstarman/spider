...
function(e, t, n) {
    ...
    function o(e, i) {
        var o = t.parseMap(e);
        g[o] ? i() : m[o] ? y[o].push(i) : (m[o] = !0, y[o] = [i], r._fetch(o,
        function() {
            g[o] = !0;
            var n = f[e];
            n.status === h.FETCHING && (n.status = h.FETCHED),
            v && (r._save(e, v), v = null),
            b && n.status === h.FETCHED && (f[e] = b, b.realUri = e),
            b = null,
            m[o] && delete m[o],
            (n = y[o]) && (delete y[o], t.forEach(n,
            function(e) {
                e()
            }))
        },
    ...
    function l(e) {
        ...
        function(e) {
            return w = [n],
            (e = c(f[e])) && (w.push(n), t.log("Found circular dependencies:", w.join(" --\x3e "), void 0)),
            !e
        })
    }
    function c(e) {
...
function(e, t) { !
    function(e, t) {
        ...
        y = o.Number.parseFloat || o.parseFloat,
        v = o.Number.isNaN || o.isNaN,
        b = o.Date.now,
        w = o.Object.keys,
        ...
        S = function(e) {
            ...
            else if ("number" == typeof e.length) for (t = [], n = 0, r = e.length; n < r; n++) x.call(e, n) && (t[n] = S(e[n]));
            else {
                t = {};
        ...
        M = "html" === a.documentElement.nodeName,
        q = {
            bridge: null,
            version: "0.0.0",
            pluginType: "unknown",
        ...
        Z = new RegExp("^flash-(" + X.filter(function(e) {
        ...
        J = function() {
            return Ye(),
            {
                browser: E(k(s, ["userAgent", "platform", "appName", "appVersion"]), {
                    isSupported: Q()
                }),
                flash: N(q, ["bridge"]),
                zeroclipboard: {
        ...
        ie = function(e) {
            ...
            e), we.call(this, t), "copy" === e.type && (n = (r = Oe(B)).data, z = r.formatMap), n)
        },
        oe = function() {
            var e = K.swfPath || "",
            t = e.slice(0, 2),
        ...
        xe = function(e) {
            var t = null;
            return (!1 === H || e && "error" === e.type && e.name && -1 !== V.indexOf(e.name)) && (t = !1),
            t
        },
        Te = function(e) {
            ...
            case "error":
                ...
                "browser-unsupported" === e.name ? E(q, {
                    disabled: !1,
                    outdated: !1,
                    unavailable: !1,
                    degraded: !1,
            ...
            case "_mouseover":
                Ke.focus(t),
                !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !j(e.relatedTarget, t) && Ce(E({},
                e, {
                    type: "mouseenter",
                    bubbles: !1,
                    cancelable: !1
        ...
        Ae = function() {
            ...
            n = ke(t);
            if (!t) {
                var r = Ie(o.location.host, K),
                i = "never" === r ? "none": "all",
                s = Fe(E({
                    jsVersion: Ke.version
                },
                K)),
                l = K.swfPath + De(K.swfPath, K);
                M && (l = Ne(l)),
                n = Se();
        ...
        Ve = function(e) {
            ...
            var t;
            return "number" != typeof e || v(e) ? "string" == typeof e && (t = Ve(g(e, 10))) : t = e,
        ...
        at = function(e) {
            var t, n = this;
            return ft.call(n, e) && ("object" == typeof e && e && "string" == typeof e.type && e.type && (e = E({},
            e)), t = E({},
            me(e), {
                client: n
            }), dt.call(n, t)),
        ...
        lt = function(e) {
            ...
            i = (e = void 0 === e ? r.slice(0) : pt(e)).length; i--;) if (x.call(e, i) && e[i] && 1 === e[i].nodeType) {
    ...
    t.init = function() {
        ...
        !(n("#copyit").length > 0)) {
            if (Clipboard.isSupported()) {
                ...
                return t.on("success",
                function(e) {
                    n("#targetCopy .tips__text--short").text("宸插鍒�"),
                    r.clog("COPY_CLICK"),
                    setTimeout(function() {
                ...
                function(e) {
                    r.clog("COPY_CLICK"),
                    alert("鎮ㄧ殑娴忚鍣ㄤ笉鏀寔鐩存帴澶嶅埗鍔熻兘锛岃鎵嬪姩澶嶅埗銆�")
                })
            }
...
function(e, t) {
    return function(e, t) {
        ...
        function o(e, t, n) {
            ...
            i = t + "queue",
            o = t + "mark",
            a = R._data(e, r); ! a || "queue" !== n && R._data(e, i) || "mark" !== n && R._data(e, o) || setTimeout(function() {
        ...
        function c(e, t, n) {
            if (t = t || 0, R.isFunction(t)) return R.grep(e,
            function(e, r) {
                return !! t.call(e, r, e) === n
            });
            if (t.nodeType) return R.grep(e,
            function(e, r) {
                return e === t === n
            });
            if ("string" == typeof t) {
        ...
        function y(e, t) {
            t.src ? R.ajax({
                ...
                async: !1,
                dataType: "script"
            }) : R.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ee, "/*$0*/")),
            t.parentNode && t.parentNode.removeChild(t)
        }
        function v(e, t, n) {
            var r = "width" === t ? e.offsetWidth: e.offsetHeight,
            i = "width" === t ? Me: qe;
            return r > 0 ? ("border" !== n && R.each(i,
            function() {
                n || (r -= parseFloat(R.css(e, "padding" + this)) || 0),
                "margin" === n ? r += parseFloat(R.css(e, n + this)) || 0 : r -= parseFloat(R.css(e, "border" + this + "Width")) || 0
            }), r + "px") : (((r = Ne(e, t, t)) < 0 || null == r) && (r = e.style[t] || 0), r = parseFloat(r) || 0, n && R.each(i,
            function() {
        ...
        function b(e) {
            return function(t, n) {
                if ("string" != typeof t && (n = t, t = "*"), R.isFunction(n)) for (var r, i, o = t.toLowerCase().split(et), a = 0, s = o.length; a < s; a++) r = o[a],
        ...
        function A(e, t) {
            var n = {};
            return R.each(bt.concat.apply([], bt.slice(0, t)),
            function() {
                n[this] = e
            }),
            n
        ...
        function j(e) {
            if (!gt[e]) {
                ...
                r = n.css("display");
                n.remove(),
                "none" !== r && "" !== r || (dt || ((dt = L.createElement("iframe")).frameBorder = dt.width = dt.height = 0), t.appendChild(dt), pt && dt.createElement || ((pt = (dt.contentWindow || dt.contentDocument).document).write(("CSS1Compat" === L.compatMode ? "<!doctype html>": "") + "<html><body>"), pt.close()), n = pt.createElement(e), pt.body.appendChild(n), r = R.css(n, "display"), t.removeChild(dt)),
                gt[e] = r
            }
            return gt[e]
        }
        ...
        R = function() {
            ...
            return s.fn = s.prototype = {
                ...
                init: function(e, n, r) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        (a = m.exec(e)) ? s.isPlainObject(n) ? (e = [L.createElement(a[1])], s.fn.attr.call(e, n, !0)) : e = [l.createElement(a[1])] : e = ((a = s.buildFragment([i[1]], [l])).cacheable ? s.clone(a.fragment) : a.fragment).childNodes,
                        s.merge(this, e);
            ...
            s.extend({
                ...
                ready: function(e) {
                    if (!0 === e && !--s.readyWait || !0 !== e && !s.isReady) {
                        ...
                        o.fireWith(L, [s]),
                        s.fn.trigger && s(L).trigger("ready").unbind("ready")
                    }
                },
                bindReady: function() {
                    if (!o) {
            ...
            (i = s.uaMatch(k)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version),
            s.browser.webkit && (s.browser.safari = !0),
            f.test("聽") && (d = /^[\s\xA0]+/, p = /[\s\xA0]+$/),
            r = s(L),
                    ...
                    pipe: function(e, t, n) {
                        return R.Deferred(function(r) {
                            ...
                            function(e, t) {
                                var n, i = t[0],
                                o = t[1];
                                R.isFunction(i) ? l[e](function() { (n = i.apply(this, arguments)) && R.isFunction(n.promise) ? n.promise().then(r.resolve, r.reject, r.notify) : r[o + "With"](this === l ? r: this, [n])
                                }) : l[e](r[o])
                            })
                        }).promise()
                    },
        ...
        R.support = function() {
            var e, t, n, r, i, o, a, s, l, c, u, f, d, p, h, m, g = L.createElement("div"),
            y = L.documentElement;
            ...
            r = (n = L.createElement("select")).appendChild(L.createElement("option")),
            ...
            (i = L.createElement("input")).value = "t",
            i.setAttribute("type", "radio"),
            a.radioValue = "t" === i.value,
            i.setAttribute("checked", "checked"),
            g.appendChild(i),
            (s = L.createDocumentFragment()).appendChild(g.lastChild),
            a.checkClone = s.cloneNode(!0).cloneNode(!0).lastChild.checked,
            g.innerHTML = "",
            g.style.width = g.style.paddingLeft = "1px",
            l = L.getElementsByTagName("body")[0],
            u = L.createElement(l ? "div": "body"),
            f = {
                visibility: "hidden",
                width: 0,
                height: 0,
            ...
            return R(function() {
                ...
                s = "visibility:hidden;border:0;"; (l = L.getElementsByTagName("body")[0]) && ((e = L.createElement("div")).style.cssText = s + "width:0;height:0;position:static;top:0;margin-top:1px", l.insertBefore(e, l.firstChild), (u = L.createElement("div")).style.cssText = o + s, u.innerHTML = "<div style='position:absolute;top:0;left:0;width:1px;height:1px;margin:0;border:5px solid #000;padding:0;'><div></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;margin:0;border:5px solid #000;padding:0;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>", e.appendChild(u), n = (t = u.firstChild).firstChild, r = t.nextSibling.firstChild.firstChild, i = {
        ...
        R.extend({
            ...
            data: function(e, n, r, i) {
                if (R.acceptData(e)) {
                    ...
                    c = e.nodeType,
                    u = c ? R.cache: e,
                    f = c ? e[R.expando] : e[R.expando] && R.expando,
                    d = "events" === n;
                    if (f && u[f] && (d || i || u[f].data) || !l || r !== t) return f || (c ? e[R.expando] = f = ++R.uuid: f = R.expando),
                    u[f] || (u[f] = {},
                    c || (u[f].toJSON = R.noop)),
                    ...
                    d && !a[n] ? o.events: (l ? null == (s = a[n]) && (s = a[R.camelCase(n)]) : s = a, s)
                }
            },
            ...
            data: function(e, n) {
                ...
                if (void 0 === e) {
                    if (this.length && (s = R.data(this[0]), 1 === this[0].nodeType && !R._data(this[0], "parsedAttrs"))) {
                        for (var l = 0,
                        c = (o = this[0].attributes).length; l < c; l++) 0 === (a = o[l].name).indexOf("data-") && (a = R.camelCase(a.substring(5)), r(this[0], a, s[a]));
        ...
        R.extend({
            ...
            dequeue: function(e, t) {
                ...
                r && ("fx" === t && n.unshift("inprogress"), R._data(e, t + ".run", i), r.call(e,
                function() {
                    R.dequeue(e, t)
                },
                i)),
                n.length || (R.removeData(e, t + "queue " + t + ".run", !0), o(e, t, "queue"))
            }
        }),
        R.fn.extend({
            queue: function(e, n) {
        ...
        R.fn.extend({
            ...
            toggleClass: function(e, t) {
                ...
                return R.isFunction(e) ? this.each(function(n) {
                    ...
                    a = R(this), s = t, l = e.split($); i = l[o++];) a[(s = r ? s: !a.hasClass(i)) ? "addClass": "removeClass"](i);
            ...
            val: function(e) {
                ...
                return arguments.length ? (i = R.isFunction(e), this.each(function(r) {
                    var o, a = R(this);
                    1 === this.nodeType && (null == (o = i ? e.call(this, r, a.val()) : e) ? o = "": "number" == typeof o ? o += "": R.isArray(o) && (o = R.map(o,
                    function(e) {
                        return null == e ? "": e + ""
        ...
        R.extend({
            ...
            attrHooks: {
                type: {
                    set: function(e, t) {
                        if (V.test(e.nodeName) && e.parentNode) R.error("type property can't be changed");
        ...
        B = {
            ...
            set: function(e, t, n) {
                var r;
                return ! 1 === t ? R.removeAttr(e, n) : ((r = R.propFix[n] || n) in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase())),
                n
            }
        },
        K || (z = {
        ...
        R.attrHooks.tabindex.set = P.set, R.each(["width", "height"],
        function(e, t) {
        ...
        R.support.hrefNormalized || R.each(["href", "src", "width", "height"],
        function(e, n) {
        ...
        R.support.checkOn || R.each(["radio", "checkbox"],
        function() {
            R.valHooks[this] = {
                get: function(e) {
        ...
        R.event = {
            add: function(e, n, r, i, o) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = R._data(e))) {
                    ...
                    h),
                    o && (p.quick = re(o), !p.quick && R.expr.match.POS.test(o) && (p.isPositional = !0)),
                ...
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    ...
                    if (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (g = (y = g.split(".")).shift(), y.sort()), i && !R.event.customEvent[g] || R.event.global[g]) if (n = "object" == typeof n ? n[R.expando] ? n: new R.Event(g, n) : new R.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = y.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = g.indexOf(":") < 0 ? "on" + g: "", !o && i || n.preventDefault(), i) {
                        if (n.result = t, n.target || (n.target = i), (r = null != r ? R.makeArray(r) : []).unshift(n), !(d = R.event.special[g] || {}).trigger || !1 !== d.trigger.apply(i, r)) {
                            ...
                            return n.type = g,
                            n.isDefaultPrevented() || d._default && !1 !== d._default.apply(i.ownerDocument, r) || "click" === g && R.nodeName(i, "a") || !R.acceptData(i) || f && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !R.isWindow(i) && ((u = i[f]) && (i[f] = null), R.event.triggered = g, i[g](), R.event.triggered = t, u && (i[f] = u)),
                            n.result
                        }
                    } else {
                        a = R.cache;
            ...
            dispatch: function(n) {
                ...
                y = (R.event.special[n.type] || {}).handle,
                v = [];
                ...
                for (p.length > h && v.push({
                    elem: this,
                    matches: p.slice(h)
                }), r = 0; r < v.length && !n.isPropagationStopped(); r++) for (l = v[r], n.currentTarget = l.elem, i = 0; i < l.matches.length && !n.isImmediatePropagationStopped(); i++) u = l.matches[i],
                (g || !n.namespace && !u.namespace || n.namespace_re && n.namespace_re.test(u.namespace)) && (n.data = u.data, n.handleObj = u, (a = (y || u.handler).apply(l.elem, m)) !== t && (n.result = a, !1 === a && (n.preventDefault(), n.stopPropagation())));
                return n.result
            },
            ...
            mouseHooks: {
                ...
                filter: function(e, n) {
                    ...
                    s = n.fromElement;
                    return null == e.pageX && null != n.clientX && (i = (r = e.target.ownerDocument || L).documentElement, o = r.body, e.pageX = n.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)),
            ...
            fix: function(e) {
                ...
                return e.target || (e.target = i.srcElement || L),
        ...
        R.removeEvent = L.removeEventListener ?
        function(e, t, n) {
        ...
        function(e, t) {
            R.event.special[e] = R.event.special[t] = {
                ...
                handle: function(e) {
                    ...
                    o = e.handleObj;
                    o.selector;
                    return i && o.origType !== e.type && (i === r || R.contains(r, i)) || (t = e.type, e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t),
                    n
                }
            }
        }),
        R.support.submitBubbles || (R.event.special.submit = {
            setup: function() {
                ...
                R.event.add(this, "click._submit keypress._submit",
                function(e) {
                    var n = e.target,
                    r = R.nodeName(n, "input") || R.nodeName(n, "button") ? n.form: t;
                    r && !r._submit_attached && (R.event.add(r, "submit._submit",
                    function(e) {
        ...
        R.support.changeBubbles || (R.event.special.change = {
            setup: function() {
                if (G.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (R.event.add(this, "propertychange._change",
                function(e) {
                    "checked" === e.originalEvent.propertyName && (this._just_changed = !0)
                }), R.event.add(this, "click._change",
                function(e) {
                    this._just_changed && (this._just_changed = !1, R.event.simulate("change", this, e, !0))
                })),
                !1;
                R.event.add(this, "beforeactivate._change",
                function(e) {
                    var t = e.target;
                    G.test(t.nodeName) && !t._change_attached && (R.event.add(t, "change._change",
                    function(e) {
        ...
        R.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
        function(e, t) {
            R.fn[t] = function(e, n) {
        ...
        function() {
            ...
            var d = function(e, t, n, i) {
                ...
                if (T.length > 1 && m.exec(e)) if (2 === T.length && h.relative[T[0]]) l = w(T[0] + T[1], t, i);
                else for (l = h.relative[T[0]] ? [t] : d(T.shift(), t); T.length;) e = T.shift(),
                h.relative[e] && (e += T.shift()),
                l = w(e, l, i);
                else if (!i && T.length > 1 && 9 === t.nodeType && !x && h.match.ID.test(T[0]) && !h.match.ID.test(T[T.length - 1]) && (t = (f = d.find(T.shift(), t, x)).expr ? d.filter(f.expr, f.set)[0] : f.set[0]), t) for (l = (f = i ? {
                    expr: T.pop(),
                    set: y(i)
                }: d.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t: t.parentNode, x)).expr ? d.filter(f.expr, f.set) : f.set, T.length > 0 ? c = y(l) : b = !1; T.length;) g = p = T.pop(),
                h.relative[p] ? g = T.pop() : p = "",
                null == g && (g = t),
                h.relative[p](c, g, x);
                else c = T = [];
                if (c || (c = l), c || d.error(p || e), "[object Array]" === a.call(c)) if (b) if (t && 1 === t.nodeType) for (v = 0; null != c[v]; v++) c[v] && (!0 === c[v] || 1 === c[v].nodeType && d.contains(t, c[v])) && n.push(l[v]);
        ...
        R.fn.extend({
            ...
            has: function(e) {
                ...
                return this.filter(function() {
                    for (var e = 0,
                    n = t.length; e < n; e++) if (R.contains(this, t[e])) return ! 0
                })
            },
            not: function(e) {
            ...
            closest: function(e, t) {
                ...
                if (R.isArray(e)) {
                    for (var a = 1; o && o.ownerDocument && o !== t;) {
                        for (n = 0; n < e.length; n++) R(o).is(e[n]) && i.push({
                            selector: e[n],
                            elem: o,
                            level: a
                        });
        ...
        R.extend({
            ...
            dir: function(e, n, r) {
                for (var i = [], o = e[n]; o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !R(o).is(r));) 1 === o.nodeType && i.push(o),
                o = o[n];
                return i
            },
        ...
        Se.th = Se.td,
        R.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]),
        R.fn.extend({
            text: function(e) {
            ...
            html: function(e) {
                ...
                if ("string" != typeof e || we.test(e) || !R.support.leadingWhitespace && me.test(e) || Se[(ye.exec(e) || ["", ""])[1].toLowerCase()]) R.isFunction(e) ? this.each(function(t) {
                    ...
                    try {
                        for (var n = 0,
                        r = this.length; n < r; n++) 1 === this[n].nodeType && (R.cleanData(this[n].getElementsByTagName("*")), this[n].innerHTML = e)
                    } catch(t) {
                        this.empty().append(e)
                    }
                }
            ...
            domManip: function(e, n, r) {
                ...
                if (this[0]) {
                    if (s = l && l.parentNode, i = R.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
                        fragment: s
                    }: R.buildFragment(e, this, c), a = i.fragment, o = 1 === a.childNodes.length ? a = a.firstChild: a.firstChild) {
                        n = n && R.nodeName(o, "tr");
                        for (var u = 0,
                        d = this.length,
                        p = d - 1; u < d; u++) r.call(n ? f(this[u]) : this[u], i.cacheable || d > 1 && u < p ? R.clone(a, !0, !0) : a)
                    }
                    c.length && R.each(c, y)
                }
                return this
        ...
        R.buildFragment = function(e, t, n) {
            ...
            1 === e.length && "string" == typeof s && s.length < 512 && a === L && "<" === s.charAt(0) && !xe.test(s) && (R.support.checkClone || !_e.test(s)) && !R.support.unknownElems && Te.test(s) && (i = !0, (o = R.fragments[s]) && 1 !== o && (r = o)),
            r || (r = a.createDocumentFragment(), R.clean(e, a, r, n)),
        ...
        R.extend({
            ...
            clean: function(e, t, n, r) {
                ...
                for (var o, a, s = [], l = 0; null != (a = e[l]); l++) if ("number" == typeof a && (a += ""), a) {
                    ...
                    var y;
                    if (!R.support.appendChecked) if (a[0] && "number" == typeof(y = a.length)) for (o = 0; o < y; o++) g(a[o]);
                    else g(a);
            ...
            cleanData: function(e) {
                for (var t, n, r, i = R.cache,
                o = R.event.special,
                a = R.support.deleteExpando,
                s = 0; null != (r = e[s]); s++) if ((!r.nodeName || !R.noData[r.nodeName.toLowerCase()]) && (n = r[R.expando])) {
                    if ((t = i[n]) && t.events) {
        ...
        R.fn.css = function(e, n) {
            return 2 === arguments.length && n === t ? this: R.access(this, e, n, !0,
            function(e, n, r) {
        ...
        R.extend({
            ...
            css: function(e, n, r) {
                ...
                o && "get" in o && (i = o.get(e, !0, r)) !== t ? i: Ne ? Ne(e, n) : void 0
            },
            swap: function(e, t, n) {
                var r = {};
        ...
        function(e, t) {
            R.cssHooks[t] = {
                get: function(e, n, r) {
                    var i;
                    if (n) return 0 !== e.offsetWidth ? v(e, t, r) : (R.swap(e, He,
                    function() {
                        i = v(e, t, r)
                    }), i)
                },
        ...
        R.support.opacity || (R.cssHooks.opacity = {
            ...
            set: function(e, t) {
                ...
                n.zoom = 1,
                t >= 1 && "" === R.trim(o.replace(Oe, "")) && (n.removeAttribute("filter"), r && !r.filter) || (n.filter = Oe.test(o) ? o.replace(Oe, i) : o + " " + i)
            }
        }),
        R(function() {
        ...
        L.defaultView && L.defaultView.getComputedStyle && (Ae = function(e, n) {
            var r, i, o;
            return n = n.replace(De, "-$1").toLowerCase(),
            (i = e.ownerDocument.defaultView) ? ((o = i.getComputedStyle(e, null)) && ("" !== (r = o.getPropertyValue(n)) || R.contains(e.ownerDocument.documentElement, e) || (r = R.style(e, n))), r) : t
        }),
        L.documentElement.currentStyle && (je = function(e, t) {
            var n, r, i, o = e.currentStyle && e.currentStyle[t],
            a = e.style;
            return null === o && a && (i = a[t]) && (o = i),
            !Fe.test(o) && Re.test(o) && (n = a.left, (r = e.runtimeStyle && e.runtimeStyle.left) && (e.runtimeStyle.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em": o || 0, o = a.pixelLeft + "px", a.left = n, r && (e.runtimeStyle.left = r)),
            "" === o ? "auto": o
        }),
        Ne = Ae || je,
        ...
        try {
            Pe = F.href
        } catch(e) { (Pe = L.createElement("a")).href = "",
            Pe = Pe.href
        }
        ...
        R.fn.extend({
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var n = R(this).val();
                    return null == n ? null: R.isArray(n) ? R.map(n,
                    function(e, n) {
                        return {
                            name: t.name,
                            value: e.replace($e, "\r\n")
        ...
        R.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),
        function(e, t) {
            R.fn[t] = function(e) {
        ...
        function(e, n) {
            R[n] = function(e, r, i, o) {
                return R.isFunction(r) && (o = o || i, i = r, r = t),
                R.ajax({
                    type: n,
                    url: e,
                    data: r,
        ...
        R.extend({
            ...
            ajaxSetup: function(e, t) {
                return t ? x(e, R.ajaxSettings) : (t = e, e = R.ajaxSettings),
                x(e, t),
                e
            },
            ajaxSettings: {
            ...
            ajax: function(e, n) {
                function r(e, n, r, a) {
                    if (2 !== x) {
                        ...
                        var c, f, v, b, w, E = n,
                        S = r ? _(d, T, r) : t;
                        if (e >= 200 && e < 300 || 304 === e) if (d.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (R.lastModified[i] = b), (w = T.getResponseHeader("Etag")) && (R.etag[i] = w)), 304 === e) E = "notmodified",
                        c = !0;
                        else try {
                            f = C(d, S),
                            E = "success",
                        ...
                        T.status = e,
                        T.statusText = "" + (n || E),
                        c ? m.resolveWith(p, [f, E, T]) : m.rejectWith(p, [T, E, v]),
                        T.statusCode(y),
                        y = t,
                        u && h.trigger("ajax" + (c ? "Success": "Error"), [T, d, c ? f: v]),
                        g.fireWith(p, [T, E]),
                        u && (h.trigger("ajaxComplete", [T, d]), --R.active || R.event.trigger("ajaxStop"))
                    }
                }
                "object" == typeof e && (n = e, e = t),
                n = n || {};
                var i, o, a, s, l, c, u, f, d = R.ajaxSetup({},
                n),
                p = d.context || d,
                h = p !== d && (p.nodeType || p instanceof R) ? R(p) : R.event,
                m = R.Deferred(),
                ...
                d.ifModified && (i = i || d.url, R.lastModified[i] && T.setRequestHeader("If-Modified-Since", R.lastModified[i]), R.etag[i] && T.setRequestHeader("If-None-Match", R.etag[i])),
            ...
            param: function(e, n) {
                ...
                if (n === t && (n = R.ajaxSettings.traditional), R.isArray(e) || e.jquery && !R.isPlainObject(e)) R.each(e,
                function() {
        ...
        function(e) {
            if (e.crossDomain) {
                ...
                return {
                    send: function(i, o) { (n = L.createElement("script")).async = "async",
        ...
        ft = 0;
        R.ajaxSettings.xhr = e.ActiveXObject ?
        function() {
                ...
                return {
                    send: function(i, o) {
                        ...
                        r = function(e, i) {
                            var s, c, u, f, d;
                            try {
                                if (r && (i || 4 === l.readyState)) if (r = t, a && (l.onreadystatechange = R.noop, ut && delete ct[a]), i) 4 !== l.readyState && l.abort();
                                else {
                                    s = l.status,
                        ...
                        R(e).unload(ut)), ct[a] = r), l.onreadystatechange = r) : r()
                    },
                    abort: function() {
                        r && r(0, 1)
                    }
        ...
        R.fn.extend({
            show: function(e, t, n) {
                ...
                for (var o = 0,
                a = this.length; o < a; o++)(r = this[o]).style && (i = r.style.display, R._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""), "" === i && "none" === R.css(r, "display") && R._data(r, "olddisplay", j(r.nodeName)));
            ...
            hide: function(e, t, n) {
                ...
                for (var r, i, o = 0,
                a = this.length; o < a; o++)(r = this[o]).style && ("none" === (i = R.css(r, "display")) || R._data(r, "olddisplay") || R._data(r, "olddisplay", i));
            ...
            animate: function(e, t, n, r) {
                function i() { ! 1 === o.queue && R._mark(this);
                    var t, n, r, i, a, s, l, c, u, f = R.extend({},
                    o),
                    d = 1 === this.nodeType,
                    p = d && R(this).is(":hidden");
                    f.animatedProperties = {};
                    for (r in e) {
                        if (t = R.camelCase(r), r !== t && (e[t] = e[r], delete e[r]), n = e[t], R.isArray(n) ? (f.animatedProperties[t] = n[1], n = e[t] = n[0]) : f.animatedProperties[t] = f.specialEasing && f.specialEasing[t] || f.easing || "swing", "hide" === n && p || "show" === n && !p) return f.complete.call(this); ! d || "height" !== t && "width" !== t || (f.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === R.css(this, "display") && "none" === R.css(this, "float") && (R.support.inlineBlockNeedsLayout && "inline" !== j(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                    }
                    null != f.overflow && (this.style.overflow = "hidden");
                    for (r in e) i = new R.fx(this, f, r),
                    n = e[r],
                    yt.test(n) ? (u = R._data(this, "toggle" + r) || ("toggle" === n ? p ? "show": "hide": 0)) ? (R._data(this, "toggle" + r, "show" === u ? "hide": "show"), i[u]()) : i[n]() : (a = vt.exec(n), s = i.cur(), a ? (l = parseFloat(a[2]), "px" !== (c = a[3] || (R.cssNumber[r] ? "": "px")) && (R.style(this, r, (l || 1) + c), s = (l || 1) / i.cur() * s, R.style(this, r, s + c)), a[1] && (l = ("-=" === a[1] ? -1 : 1) * l + s), i.custom(s, l, c)) : i.custom(s, n, ""));
                    return ! 0
                }
                var o = R.speed(t, n, r);
                return R.isEmptyObject(e) ? this.each(o.complete, [!1]) : (e = R.extend({},
            ...
            stop: function(e, n, r) {
                ...
                this.each(function() {
                    ...
                    o = R.timers,
                    a = R._data(this);
                    if (r || R._unmark(!0, this), null == e) for (n in a) a[n].stop && n.indexOf(".run") === n.length - 4 && t(this, a, n);
        ...
        R.extend({
            speed: function(e, t, n) {
                var r = e && "object" == typeof e ? R.extend({},
                e) : {
        ...
        R.fx.prototype = {
            ...
            step: function(e) {
                ...
                if (e || i >= s.duration + this.startTime) {
                    ...
                    if (o) {
                        if (null == s.overflow || R.support.shrinkWrapBlocks || R.each(["", "X", "Y"],
                        function(e, t) {
                            a.style["overflow" + t] = s.overflow[e]
                        }), s.hide && R(a).hide(), s.hide || s.show) for (t in s.animatedProperties) R.style(a, t, s.orig[t]),
                        R.removeData(a, "fxshow" + t, !0),
                        R.removeData(a, "toggle" + t, !0); (r = s.complete) && (s.complete = !1, r.call(a))
                    }
                    return ! 1
                }
                return s.duration == 1 / 0 ? this.now = i: (n = i - this.startTime, this.state = n / s.duration, this.pos = R.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration), this.now = this.start + (this.end - this.start) * this.pos),
                this.update(),
                !0
            }
        },
        ...
        "getBoundingClientRect" in L.documentElement ? R.fn.offset = function(e) {
            ...
            a = i.body,
            s = i.defaultView,
            l = s ? s.getComputedStyle(t, null) : t.currentStyle, c = t.offsetTop, u = t.offsetLeft; (t = t.parentNode) && t !== a && t !== o && (!R.support.fixedPosition || "fixed" !== l.position);) n = s ? s.getComputedStyle(t, null) : t.currentStyle,
            c -= t.scrollTop,
            u -= t.scrollLeft,
            t === r && (c += t.offsetTop, u += t.offsetLeft, !R.support.doesNotAddBorder || R.support.doesAddBorderForTableAndCells && wt.test(t.nodeName) || (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0), r, r = t.offsetParent),
            R.support.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0),
            l = n;
            return "relative" !== l.position && "static" !== l.position || (c += a.offsetTop, u += a.offsetLeft),
            R.support.fixedPosition && "fixed" === l.position && (c += Math.max(o.scrollTop, a.scrollTop), u += Math.max(o.scrollLeft, a.scrollLeft)),
            {
                top: c,
                left: u
            }
        ...
        R.offset = {
            ...
            setOffset: function(e, t, n) {
                ...
                c = R.css(e, "left"),
                u = {},
                f = {}; ("absolute" === r || "fixed" === r) && R.inArray("auto", [l, c]) > -1 ? (i = (f = a.position()).top, o = f.left) : (i = parseFloat(l) || 0, o = parseFloat(c) || 0),
        ...
        function(e, n) {
            ...
            R.fn[r] = function(n) {
                var i, o;
                return n === t ? (i = this[0]) ? (o = O(i)) ? "pageXOffset" in o ? o[e ? "pageYOffset": "pageXOffset"] : R.support.boxModel && o.document.documentElement[r] || o.document.body[r] : i[r] : null: this.each(function() { (o = O(this)) ? o.scrollTo(e ? R(o).scrollLeft() : n, e ? n: R(o).scrollTop()) : this[r] = n
                })
            }
        }),
        R.each(["Height", "Width"],
...
define("newweb/common/requestMoreTrans", ["./md5", "./jquery-1.7", "./utils"],
function(e, t) {
    var n = e("./jquery-1.7");
    e("./md5");
    e("./utils");
...
function(e, t) {
    ...
    n.fn.select = function(e) {
        ...
        t.find(".select").click(function(e) {
            ...
            "LI" != i[0].tagName && (i = i.parents("li").eq(0)),
            i.hasClass("selected") || (n(this).find("li").removeClass("selected"), i.addClass("selected"), n(this).slideUp("fast"), n(this).parent().find(".select-text").text(o), n(this).parent().find(".select-input").val(o), r.call(t), e.stopPropagation(), e.cancelBubble = !0)
        })
    },
...
define("newweb/common/translate", ["./utils", "./voice", "./TranslateState", "./log", "./service", "./md5", "./jquery-1.7", "./smartResult", "./requestMoreTrans"],
function(e, t) {
    function n() {
    ...
    function r(e) {
        ...
        n = [], r = 0, i = L(j.state.type) ? " ": "", o = 0; o < t.length; o++) {
            var a = t[o],
            s = [];
            r += a.length;
        ...
        var f = n.join("");
        w.html(f),
        j.state.originalTgt = w.text(),
        j.state.smallFont ? w.addClass("input__target__text--small") : w.removeClass("input__target__text--small")
    }
    function i() {
        var e = u.trim(b.val());
        e = e.replace(/\n/g, "").replace(/\r\n/g, ""),
    ...
    function o(e) {
        if (0 == u('li[data-value="' + e + '"]').length) u("#langSelect").selectValue("AUTO");
        else {
            u("#langSelect").selectValue(e);
            var t = u(".select-text").text();
            j.state.isSelectLan || u(".select-text").text("妫€娴嬪埌锛�" + t)
        }
    }
    function a(e) {
        e && 0 == e.errorCode ? (j.state = u.extend(j.state, e), o(j.state.type), r(e), e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (y.clog("RESULT_DICT_SHOW"), g.render(e.translateResult[0][0].src, e.smartResult)) : g.hide(), d.showVoice(j.state.type)) : w.html(""),
        D()
    }
    function s(e, t) {
        if (j.state.originalText = e.i, "first" == e.action) return a(global.translatedJson),
        void t();
        p && (p.abort(), p = null),
        p = u.ajax({
            type: "POST",
    ...
    function() {
        ...
        function r() {
            S && (clearTimeout(S), S = "", u(".fanyi__update__tip").stop(!0, !0)),
        ...
        function() {
            if (!h) {
                ...
                o = j.state.translateResult[r][i].src,
                a = e(r, i),
                ...
                n.addClass("hover"),
                y.clog("MATCHING_HOVER&type=" + j.state.type)
            }
        }),
        ...
        function() {
            if (!h) {
                ...
                i = j.state.translateResult[n][r].src,
                o = j.state.translateResult[n][r].tgt,
                a = e(n, r),
                ...
                y.clog("MUL_RESULT_CLICK&type=" + j.state.type);
                var c = j.state.getDetectedFromTo()[0],
                f = j.state.getDetectedFromTo()[1];
                l(t, {
                    i: i,
                    tgt: o,
                    from: c,
        ...
        u("#fanyiSuggest").delegate("li", "click",
        function() {
            var e = j.state.updateEle,
            t = u(this).text(),
            ...
            n(),
            e.addClass("updated");
            var o = j.state.updateEle,
            a = o.attr("data-section"),
            s = o.attr("data-sentence"),
            l = j.state.translateResult[a][s].src,
            c = j.state.translateResult[a][s].tgt,
            f = j.state.getDetectedFromTo()[0],
            d = j.state.getDetectedFromTo()[1];
        ...
        u(".suggest__title--close").on("click",
        function() {
            c()
        }),
        w.delegate("span", "mouseout",
        function() {
            h || (u("#transTarget span.hover").removeClass("hover"), A || b.selectRange({
                start: 0,
                end: 0
            }), r())
        }),
        u(".input__target").on("mousedown",
        function(e) {
            i(),
            h = !0,
            u("#transTarget span.hover").removeClass("hover"),
        ...
        u(".input__target").on("mouseup",
        function(e) {
            null == f.getSelectionText() && (h = !1),
            o()
        }),
        u(".suggest__update__btn").on("click",
        function() {
    ...
    t.translate = function(e, t) {
        ...
        if (D(), x.text(a), a > 5e3) {
            ...
            u("#inputTargetError").text("鏈夐亾缈昏瘧瀛楁暟闄愬埗涓�5000瀛楋紝鈥�" + c + "鈥濆強鍏跺悗闈㈡病鏈夎缈昏瘧!").show(),
...
define("newweb/index", ["./common/log", "./common/hotLink", "./common/download", "./common/utils", "./common/voice", "./common/TranslateState", "./operations", "./langSelect", "./common/star", "./common/select", "./common/manTranslate", "./input", "./common/textAuto", "./common/translate", "./common/service", "./common/md5", "./common/jquery-1.7", "./common/smartResult", "./common/requestMoreTrans", "./common/copy", "./common/ZeroClipboard", "./common/updateResult"],
function(e) {
...
define("newweb/input", ["./common/textAuto", "./common/translate", "./common/utils", "./common/voice", "./common/TranslateState", "./common/log", "./common/service", "./common/md5", "./common/jquery-1.7", "./common/smartResult", "./common/requestMoreTrans", "./common/star"],
function(e, t) {
    function n() {
        var e = u.val(),
        t = 0,
    ...
    function s(e) {
        ...
        function() {
            r()
        }), v.reset()) : (a(), m.showVoice("AUTO"), l("#transTarget").html(""), l("#transTarget").css("height", "auto"), u.css("height", "auto"), g.hide()),
        i()
    }
...
function(e, t) {
    function n() {
        "ON" === f.cookie("YOUDAO_FANYI_SELECTOR") ? (c(".fanyi__operations--underline").addClass("fanyi__operations--underline--checked"), YoudaoSelector.Config.select = "on") : (c(".fanyi__operations--underline").removeClass("fanyi__operations--underline--checked"), YoudaoSelector.Config.select = "off"),
        c(".fanyi__operations--underline").on("click",
        function() {
            var e = c(this);
    ...
    function i() {
        if (c(".login-link").length > 0) {
            ...
            c(".login-link").attr("href", e)
        }
    }
    function o() {
        c(".user-name").hover(function() {
            p && (clearTimeout(p), p = ""),
            c(".account-cover").show()
        },
        function() {
    ...
    function s() {
        var e = c(".fanyi__nav").outerHeight(!0),
        t = c(".fanyi"),
        n = c(".fanyi__footer").outerHeight(!0),
        r = c(window).height();
        t.css("min-height", r - n - e),
        c(".fanyi__footer").show()
    }
    function l() {
        var e = function() {
        ...
        "1" !== f.storage("rengongEntrance") ? (f.storage("rengongEntrance", "1"), c(".rengong__guide").show()) : (c(".rengong__guide").addClass("rengong__guide--nobtn"), c(".rengong__guide").hide(), e()),
        c(".i-know").on("click",
        function() {
            c(".rengong__guide").hide(),
            f.storage("rengongEntrance", "1"),
            c(".rengong__guide").addClass("rengong__guide--nobtn"),
            e()
        })
    }
    var c = e("./common/jquery-1.7"),
    u = e("./langSelect"),
    f = e("./common/utils"),
    d = e("./common/log"),
    p = "";
